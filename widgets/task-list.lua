...
local function list_update(w, buttons, label, data, objects)
   ...
   for i, o in ipairs(objects) do
      ...
      if cache then
         ...
         cb = clickable_container(wibox.container.margin(wibox.widget.imagebox(ICON_DIR .. "/titlebar/close_focus.svg"), dpi(4), dpi(4), dpi(4), dpi(4)))
         ...
         tbm = wibox.container.margin(tb, dpi(12), dpi(4))
         ibm = wibox.container.margin(ib, dpi(12), dpi(6), dpi(6), dpi(6))
         ...
         bg_clickable.shape = function(cr, width, height)
      ...
      bgb.shape = args.shape or function(cr, width, height)
         gears.shape.partially_rounded_rect(cr, width, height, false, false, true, true, corner_radius)
      end
